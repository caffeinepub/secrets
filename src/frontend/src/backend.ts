...
export class Backend implements backendInterface {
    ...
    async getSecret(arg0: bigint): Promise<Secret> {
        if (this.processError) {
            try {
                const result = await this.actor.getSecret(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSecrets(arg0: string, arg1: bigint): Promise<Array<SecretPreview>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSecrets(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reactToSecret(arg0: bigint, arg1: string): Promise<ReactionCounts> {
        if (this.processError) {
            try {
                const result = await this.actor.reactToSecret(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitSecret(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSecret(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
